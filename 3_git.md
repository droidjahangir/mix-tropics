...
ভুলে কোন কমিট দিয়ে ফেল্লে `reset` করতে হয় কিন্তু ঐ কমিটটা যদি `push` হয়ে যায় তাহলে আর ভুলেও `commit` করা যাবে না 
...
git reset <file-name>
``` 
rm কমান্ডটা ফাইলটাকে ডিলিট করে দিয়েছিলো এবং staging এরিয়াতে সেট করে দিয়েছিলো এরপর reset কমান্ড এর মাদ্ধমে ফাইলটাকে staging এরিয়াথেকে বের করে দিলো 
